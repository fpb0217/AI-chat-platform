...
| Query 定位滚动条 | [正文区域用户 Query 定位滚动条](query_scroll_navigator/query_scroll_navigator.md) | `accepted` | 2026-08-11 |
| 消息 Token 用量展示 | [消息 Token 用量展示](message_token_usage/message_token_usage.md) | `accepted` | 2026-08-11 |
